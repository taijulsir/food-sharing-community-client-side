      ...
      <div className="font-[sans-serif] text-[#333]">
        <div className=" container  mx-auto my-16">
          ...
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-8 max-md:justify-center mt-8">
            ...
            <div className="grid grid-cols-3 items-center bg-teal-900/70 p-4 rounded-md relative c">
              <div className="col-span-2">
                <img src="https://readymadeui.com/team-2.webp" className="rounded-md bg-teal-600" />
                <div className="flex items-center justify-center mt-3 ">
                  <a className="inline-block mr-5 text-blue-800 dark:text-gray-400 hover:text-blue-600"
                    >
                  ...
                  <a className="inline-block mr-5 text-blue-500 dark:text-gray-400 hover:text-blue-400"
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  ...
                  <a className="inline-block text-pink-600 dark:text-gray-400 hover:text-pink-500" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <div className="bg-teal-400 rounded-md p-4 absolute right-4 shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] ">
