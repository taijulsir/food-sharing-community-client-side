        ...
        <div className="px-4 py-10 mx-auto lg:py-20 container">
            ...
            <div className="grid grid-cols-1 gap-4 lg:gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white"> Food Sharing Hub </h3>
                ...
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white"> Building Connections </h3>
                    <p className="text-base text-white dark:text-gray-400">
                ...
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white"> Sustainable Practices </h3>
                    <p className="text-base text-white dark:text-gray-400">
                ...
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white"> Fostering Compassion </h3>
                    <p className="text-base text-white dark:text-gray-400">
                ...
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white">Reducing Food Waste </h3>
                    <p className="text-base text-white dark:text-gray-400">
                ...
                <div className="w-full p-8 transition-all bg-teal-900/60 rounded shadow dark:bg-gray-700 hover:shadow-lg">
                    ...
                    <h3 className="mb-4 text-2xl font-bold dark:text-white"> Nourishing Communities </h3>
                    <p className="text-base text-white dark:text-gray-400">
